...
6. 整合 FComSharedFlowAdapter Protocol（nickname 建立）
7. 支援留言和回覆（透過 parentId 區分）

## 驗收條件

- [ ] UseCase 商業邏輯實作完成
- [ ] 登入檢查邏輯實作完成
- [ ] Nickname 檢查和建立邏輯實作完成
- [ ] 所有 Test Scenarios 通過（Basic / Branch / Optional / Error / Edge Case）
- [ ] Unit Test 覆蓋率 ≥ 90%
- [ ] Integration Test 通過
...
- +2 SP：複雜的驗證邏輯（登入檢查、nickname 檢查）
- +2 SP：複雜的商業邏輯（留言 vs 回覆）
